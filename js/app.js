(() => {
    ...
    const priceBtn = document.querySelectorAll(".price__nav-btn");
    const priceTab = document.querySelectorAll(".price__tab");
    const servicesBtn = document.querySelectorAll(".services__nav-btn");
    const servicesTab = document.querySelectorAll(".services__tab");
    priceBtn.forEach(onTabClick);
    servicesBtn.forEach(onTabClick2);
    function onTabClick(item) {
        item.addEventListener("click", (function() {
            ...
            if (!currentBtn.classList.contains("pressed")) {
                ...
                priceTab.forEach((function(item) {
                    item.classList.remove("pressed");
                }));
                currentBtn.classList.add("pressed");
                currentTab.classList.add("pressed");
            }
        }));
    }
    function onTabClick2(item) {
        item.addEventListener("click", (function() {
            ...
            if (!currentBtn.classList.contains("pressed")) {
                ...
                servicesTab.forEach((function(item) {
                    item.classList.remove("pressed");
                }));
                currentBtn.classList.add("pressed");
                currentTab.classList.add("pressed");
